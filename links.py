...
class Links:
    base_url = 'https://stellarburgers.nomoreparties.site/' # Линка на  страницу главную
    link_login_page = f'{base_url}login' # Линка на  страницу с авторизацией пользователя
