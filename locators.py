...
class LocatorsLoginPage:
    email_field_login_page = (By.XPATH, '//label[text()="Email"]/following-sibling::input')   # Локатор для поля Email на логин странице
    password_field_login_page = (By.XPATH, '//label[text()="Пароль"]/following-sibling::input') # Локатор для поля pawword на логин странице
...
class LocatorsMainPage:
    ...
    make_order_button = (By.XPATH, '//button[text()="Оформить заказ"]')  # Локатор кнопки оформить заказ на главное странице
    ...
    div_with_ingredients_and_scroll = (By.XPATH, '//div[contains(@class, "BurgerIngredients_ingredients__menuContainer__Xu3Mo")]')
    ...
    ingredient_detail_header = (By.XPATH, '//*[@id="root"]/div/section[1]')
